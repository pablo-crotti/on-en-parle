...
export default {
    ...
    methods: {
        ...
        recordMessage() {
            const call = (document.getElementById("call").dataset.display =
                "false");
            const sendMessage = (document.getElementById(
                "send-message"
            ).dataset.display = "false");
            const sendRecord = (document.getElementById(
                "send-record"
            ).dataset.display = "true");
            const input = (document.getElementById(
                "input-message"
            ).dataset.display = "false");
            const recorder = (document.getElementById(
                "audio-recorder"
            ).dataset.display = "true");
            const recordMessage = (document.getElementById(
                "record-message"
            ).dataset.display = "false");
            const del = (document.getElementById("delete").dataset.display =
                "true");
